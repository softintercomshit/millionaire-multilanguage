...
LANG_CHOICES = (
    ...
    ('zh_Hant_MO', 'Chinese (Traditional, Macau [China])'),
    ...
    ('es_FK', 'Spanish (Falkland Islands)'),
    ...
    ('zh_Hant_HK', 'Chinese (Traditional, Hong Kong [China])'),
    ...
    ('es_SR', 'Spanish (Suriname)'),
    ('en_MO', 'English (Macau [China])'),
    ('ar_TD', 'Arabic (Chad)'),
    ('dz', 'Dzongkha'),
    ('ses', 'Koyraboro Senni'),
    ...
    ('fa_IR', 'Persian (Iran)'),
    ('pt_FR', 'Portuguese (France)'),
    ('uz_Latn_UZ', 'Uzbek (Latin, Uzbekistan)'),
    ('zh_Hans_CN', 'Chinese (Simplified, China)'),
    ('ewo_CM', 'Ewondo (Cameroon)'),
    ('fr_PF', 'French (French Polynesia)'),
    ('ca_IT', 'Catalan (Italy)'),
    ('es_GY', 'Spanish (Guyana)'),
    ...
    ('es_PM', 'Spanish (St. Pierre & Miquelon)'),
    ...
    ('es_BM', 'Spanish (Bermuda)'),
    ('en_TC', 'English (Turks & Caicos Islands)'),
    ('es_AI', 'Spanish (Anguilla)'),
    ('ar_EG', 'Arabic (Egypt)'),
    ('fr_BJ', 'French (Benin)'),
    ('gu', 'Gujarati'),
    ...
    ('en_WS', 'English (Samoa)'),
    ('es_CU', 'Spanish (Cuba)'),
    ('es_BQ', 'Spanish (Caribbean Netherlands)'),
    ('ja_JP', 'Japanese (Japan)'),
    ('fy_NL', 'Western Frisian (Netherlands)'),
    ('en_SC', 'English (Seychelles)'),
    ('yue_Hant_HK', 'Cantonese (Traditional, Hong Kong [China])'),
    ('en_IO', 'English (British Indian Ocean Territory)'),
    ('pt_PT', 'Portuguese (Portugal)'),
    ('en_HK', 'English (Hong Kong [China])'),
    ...
    ('es_CW', 'Spanish (Curaçao)'),
    ('dua', 'Duala'),
    ('en_UM', 'English (U.S. Outlying Islands)'),
    ('es_BS', 'Spanish (Bahamas)'),
    ...
    ('nl_CW', 'Dutch (Curaçao)'),
    ('es_MQ', 'Spanish (Martinique)'),
    ('en_HR', 'English (Croatia)'),
    ('en_FJ', 'English (Fiji)'),
    ('fi', 'Finnish'),
    ('pt_MO', 'Portuguese (Macau [China])'),
    ('be', 'Belarusian'),
    ...
    ('bm', 'Bambara'),
    ('es_VC', 'Spanish (St. Vincent & Grenadines)'),
    ('ar_BH', 'Arabic (Bahrain)'),
    ('guz', 'Gusii'),
    ('bn', 'Bangla'),
    ('bo', 'Tibetan'),
    ('ar_SY', 'Arabic (Syria)'),
    ('es_MS', 'Spanish (Montserrat)'),
    ('lo_LA', 'Lao (Laos)'),
    ('ne_NP', 'Nepali (Nepal)'),
    ('uz_Latn', 'Uzbek (Latin)'),
    ...
    ('zh_Hans_MO', 'Chinese (Simplified, Macau [China])'),
    ('de_IT', 'German (Italy)'),
    ('ff_GN', 'Fulah (Guinea)'),
    ('bs_Cyrl', 'Bosnian (Cyrillic)'),
    ('nds_NL', 'Low German (Netherlands)'),
    ('es_KN', 'Spanish (St. Kitts & Nevis)'),
    ...
    ('es_VG', 'Spanish (British Virgin Islands)'),
    ('bem_ZM', 'Bemba (Zambia)'),
    ('kde', 'Makonde'),
    ('ar_OM', 'Arabic (Oman)'),
    ...
    ('es_VI', 'Spanish (U.S. Virgin Islands)'),
    ('dje', 'Zarma'),
    ...
    ('ar_YE', 'Arabic (Yemen)'),
    ('es_TC', 'Spanish (Turks & Caicos Islands)'),
    ('bm_ML', 'Bambara (Mali)'),
    ('yo', 'Yoruba'),
    ...
    ('cs_CZ', 'Czech (Czechia)'),
    ('fr_TD', 'French (Chad)'),
    ('zh_Hans_HK', 'Chinese (Simplified, Hong Kong [China])'),
    ('is', 'Icelandic'),
    ('ksh', 'Colognian'),
    ('my', 'Burmese'),
...
class Language(models.Model):
    name = models.CharField(max_length=10, unique=True, choices=LANG_CHOICES)
